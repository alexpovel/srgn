use betterletters::{
    ...
    stages::{ReplacementStage, SqueezeStage},
    RegexPattern, Stage,
};
...
proptest! {
    ...
    #[test]
    fn test_scoping_anything_at_all_is_always_faster_when_replacing(
        ...
        input in r"\p{Any}*A\p{Any}*"
    ) {
        let stage = ReplacementStage::default();
